...
## Corpus Check
- 85 files · ~74,240 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 755 nodes · 1120 edges · 49 communities (42 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `22f35e1b`
...
Cohesion: 0.08
Nodes (50): PRESETS, Step, StepView(), Turn, json(), POST(), Step, tools (+42 more)
...
Cohesion: 0.05
Nodes (41): dependencies, @anthropic-ai/sdk, geist, next, react, react-dom, @tanstack/react-query, viem (+33 more)
...
Cohesion: 0.25
Nodes (9): Agent is Untrusted by Design, Authorization vs Settlement Boundary, Claim Only What Is Verified, Contract is the Only Gate, Architecture Document, Fiat Stays Off-Chain, Model B: Authority on Chain, No Client-Side Policy Enforcement (+1 more)
...
Cohesion: 0.15
Nodes (14): Agentcard (Competitor), Cumulative Spending Cap, Pitch Deck Document, EIP-712 Typed Data Signing, ERC-4337 Account Abstraction, Kelemahan Model B Risk Analysis, NTU InnovateX Hackathon 2026, OpenClaw Incident (Feb 2026) (+6 more)
...
Cohesion: 0.25
Nodes (8): AI Agent Harness (apps/agent), Anthropic SDK (@anthropic-ai/sdk), Claude Opus 5, Lane A: Contracts & Backend, Lane B: Frontend & Agent, The Refusal is the Hero, Stamped Ledger Design Concept, Team Workflow
...
Cohesion: 0.29
Nodes (8): Leash Web Design System, Next.js, Paper Ground (#F2F1EC), Refusal Red (#C0201A), Refusal Stamp Component, tailwindcss, Volt Green (#CCFF00), Web Frontend (apps/web)
...
Cohesion: 0.17
Nodes (11): Codex/Hermes Implementation Prompt, Demo Utama, Masalah, Non-goals, P0, P1, Pengguna Awal, PRD Leash (+3 more)
...
## Knowledge Gaps
- **345 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `name`, `version`, `private` (+340 more)
...
- **Why does `Leash` connect `Project README` to `Community 33`, `Architecture & Contract`, `Pitch Deck`, `Community 22`, `Community 25`, `Leash Web Design System`, `Community 29`?**
  _High betweenness centrality (0.073) - this node is a cross-community bridge._
- **Why does `Leash Implementation Plan` connect `Community 29` to `Community 33`, `Community 26`, `Community 42`, `Project README`, `Community 46`, `Team Workflow`, `Community 18`, `Community 20`, `Community 53`, `Community 54`, `Community 23`, `Community 58`?**
  _High betweenness centrality (0.060) - this node is a cross-community bridge._
- **Why does `Web Frontend (apps/web)` connect `Leash Web Design System` to `Community 25`, `Web Dependencies`, `Project README`, `Community 22`?**
