...
## Corpus Check
- 81 files · ~71,484 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 724 nodes · 1064 edges · 48 communities (41 shown, 7 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 8 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2b514807`
...
6. `7. Milestone M1: Mandate Smart Contract` - 12 edges
7. `LeashMandate Contract` - 12 edges
8. `shortHex()` - 11 edges
9. `PRD — Leash (English)` - 11 edges
...
Cohesion: 0.21
Nodes (17): loadAbi(), AgentSession, createAgentSession(), main(), AgentConfig, loadConfig(), loadOwnerAccount(), addressEnv() (+9 more)
...
Cohesion: 0.05
Nodes (38): dependencies, @anthropic-ai/sdk, geist, next, react, react-dom, @tanstack/react-query, viem (+30 more)
...
Cohesion: 0.33
Nodes (7): Cumulative Spending Cap, OpenClaw Incident (Feb 2026), Prompt Injection Attack, Mandate Revocation, Session Key, Spending Mandate, Target Allowlist
...
Cohesion: 0.40
Nodes (4): Pitch Deck Document, EIP-712 Typed Data Signing, ERC-4337 Account Abstraction, NTU InnovateX Hackathon 2026
...
Cohesion: 0.08
Nodes (34): AI Agent Harness (apps/agent), Anthropic SDK (@anthropic-ai/sdk), Leash Web Design System, wagmi, tailwindcss, AuthorizationGranted Event, Backend Event Listener (apps/backend), Base Sepolia Testnet (+26 more)
...
Cohesion: 0.33
Nodes (5): Agentcard (Competitor), Codex/Hermes Implementation Prompt, Leash Execution Plan, Kelemahan Model B Risk Analysis, Risk and Limitations Document
...
## Knowledge Gaps
- **339 isolated node(s):** `name`, `version`, `private`, `type`, `agent` (+334 more)
...
- **Why does `Leash` connect `Project README` to `Community 35`, `Architecture & Contract`, `Community 22`, `Community 25`, `Community 29`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `Leash Implementation Plan` connect `Community 29` to `Community 35`, `Community 26`, `Community 42`, `Project README`, `Community 46`, `Team Workflow`, `Community 18`, `Community 20`, `Community 53`, `Community 54`, `Community 23`, `Community 58`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `Web Frontend (apps/web)` connect `Community 25` to `Project README`?**
